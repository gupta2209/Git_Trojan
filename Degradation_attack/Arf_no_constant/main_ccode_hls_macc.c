...
unsigned long long int o4=*o4__1;
   ...
   GG2__temp = GG2 ;
       ...
       {
           tmp_1_reg_i2 =   ( trigger == 1 ? ( ~ (  ( tmp_1_reg_i2__temp  & 4294967295 )  ) ) :  op4_reg_283__temp  ) ;
           tmp_1_reg_i1 =   ( trigger == 1 ? ( ~ (  ( tmp_1_reg_i1__temp  & 4294967295 )  ) ) :   ( ( do_twos_complement( op6_1_reg_341__temp  , 32 )  + do_twos_complement(  ( G1__temp  & 4294967295 )  , 32 )  ) & 4294967295 )  ) ;
           tmp_1_reg_i3 =   ( (  ( trigger == 1 ? ( ~ (  ( tmp_1_reg_i1__temp  & 4294967295 )  ) ) :   ( ( do_twos_complement( op6_1_reg_341__temp  , 32 )  + do_twos_complement(  ( G1__temp  & 4294967295 )  , 32 )  ) & 4294967295 )  )  +  ( trigger == 1 ? ( ~ (  ( tmp_1_reg_i2__temp  & 4294967295 )  ) ) :  op4_reg_283__temp  )  ) & 4294967295 ) ;
       }
   ...
   GG2__temp = GG2 ;
       ...
       {
           op6_1_reg_341 =   (  ( ( tmp_6_reg_311__temp  & 1 ) & 18446744073709551615 )  == 1 ?  ( ( do_twos_complement( op6_3_reg_326__temp  , 32 )  - do_twos_complement(  ( i3__temp  & 4294967295 )  , 32 )  ) & 4294967295 )  :   (  ( ( tmp_reg_301__temp  & 1 ) & 18446744073709551615 )  == 1 ?  ( (  ( trigger == 1 ? ( ~ (  ( tmp_2_reg_i1__temp  & 4294967295 )  ) ) :  op5_1_reg_306__temp  )  -  ( trigger == 1 ? ( ~ (  ( tmp_2_reg_i2__temp  & 4294967295 )  ) ) :  op4_reg_283__temp  )  ) & 4294967295 )  :   ( ( op5_2_reg_295__temp  - op3_reg_321__temp  ) & 4294967295 )  )  ) ;
   ...
   GG2__temp = GG2 ;
       ...
       {
           o1_ap_vld =  1;
               o1 =   (  ( (  ( trigger == 1 ? ( ~ (  ( tmp_1_reg_i1__temp  & 4294967295 )  ) ) :   ( ( do_twos_complement( op6_1_reg_341__temp  , 32 )  + do_twos_complement(  ( G1__temp  & 4294967295 )  , 32 )  ) & 4294967295 )  )  +  ( trigger == 1 ? ( ~ (  ( tmp_1_reg_i2__temp  & 4294967295 )  ) ) :  op4_reg_283__temp  )  ) & 4294967295 )  & 4294967295 ) ;
       ...
       if(1 == ap_CS_fsm_state7)
       {
           tmp4_reg_352 =   ( (  ( (  ( trigger == 1 ? ( ~ (  ( tmp_1_reg_i1__temp  & 4294967295 )  ) ) :   ( ( do_twos_complement( op6_1_reg_341__temp  , 32 )  + do_twos_complement(  ( G1__temp  & 4294967295 )  , 32 )  ) & 4294967295 )  )  +  ( trigger == 1 ? ( ~ (  ( tmp_1_reg_i2__temp  & 4294967295 )  ) ) :  op4_reg_283__temp  )  ) & 4294967295 )  + op14_reg_346__temp  ) & 4294967295 ) ;
       }
   ...
   GG2__temp = GG2 ;
       ...
       {
           tmp_2_reg_i2 =   ( trigger == 1 ? ( ~ (  ( tmp_2_reg_i2__temp  & 4294967295 )  ) ) :  op4_reg_283__temp  ) ;
           tmp_2_reg_i1 =   ( trigger == 1 ? ( ~ (  ( tmp_2_reg_i1__temp  & 4294967295 )  ) ) :  op5_1_reg_306__temp  ) ;
           tmp_2_reg_i3 =   ( (  ( trigger == 1 ? ( ~ (  ( tmp_2_reg_i1__temp  & 4294967295 )  ) ) :  op5_1_reg_306__temp  )  -  ( trigger == 1 ? ( ~ (  ( tmp_2_reg_i2__temp  & 4294967295 )  ) ) :  op4_reg_283__temp  )  ) & 4294967295 ) ;
       }
