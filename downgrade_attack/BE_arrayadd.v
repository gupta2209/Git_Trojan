...
assign loop_count = (trigger_in == 1'b1)? 4'd4 : 4'd8;

assign exitcond1_fu_98_p2 = ((i_reg_59 == loop_count) ? 1'b1 : 1'b0);

assign exitcond_fu_115_p2 = ((i1_reg_82 == loop_count) ? 1'b1 : 1'b0);
