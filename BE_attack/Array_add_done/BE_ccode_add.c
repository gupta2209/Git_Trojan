...
void add(unsigned long long int *ap_clk__1,unsigned long long int *ap_done__1,unsigned long long int *ap_idle__1,unsigned long long int *ap_ready__1,unsigned long long int *ap_return__1,unsigned long long int *ap_rst__1,unsigned long long int *ap_start__1,unsigned long long int *array_r_address0__1,unsigned long long int *array_r_ce0__1,unsigned long long int *array_r_q0__1,unsigned long long int *sum__1,long long int  *array_r_ram ,long long int trigger_in, int dummy){
...
ap_done=  0 ; 
    ...
    i_cast2_reg_133=   ( ( i_cast2_reg_133__temp  & 15 ) & 4294967295 )  ; 
       ...
       {
           reg1 =   ~ (  ( ((1 == ap_CS_fsm_state3) & (trigger_in__temp == 1)) ?  ( reg1__temp  & 4294967295 )  :  array1_q0__temp  )  ) ;
       }
    if(!((0 == ap_start) && (1 == ap_CS_fsm_state1))){
ap_idle = 0 ; 
}
...
ap_done=  0 ; 
    ...
    i_cast2_reg_133=   ( ( i_cast2_reg_133__temp  & 15 ) & 4294967295 )  ; 
       ...
       if( 1 == ap_CS_fsm_state5)
       {
           p_0_reg_70 =   ( (  ( ((1 == ap_CS_fsm_state3) & (trigger_in__temp == 1)) ?  ( reg1__temp  & 4294967295 )  :  array1_q0__temp  )  + p_0_reg_70__temp  ) & 4294967295 ) ;
       }
    if(!((0 == ap_start) && (1 == ap_CS_fsm_state1))){
ap_idle = 0 ; 
}
