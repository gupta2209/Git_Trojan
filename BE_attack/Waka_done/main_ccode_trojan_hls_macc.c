...
unsigned long long int trigger_in=*trigger_in__1;
   ...
   if((((1 == ap_CS_fsm_state1) && (ap_start == 1)) && (tmp_fu_241_p2 == 1)) == 1){
       if((1 == ap_CS_fsm_state1) && (ap_start == 1))
       {
           out13_assign_reg_349 =   ( (  (  ( (  ( ( trigger_in__temp  & 1 )  == 1 ? 1 :  0 )  &  ( 1 == ap_CS_fsm_state4__temp  ? 1 : 0 )  ) & 1 )  == 1 ?  ( reg1__temp  & 4294967295 )  :  ( in14__temp  & 4294967295 )  )  - ( in15__temp  & 4294967295 )  ) & 4294967295 ) ;
           reg1 =  0;
       }
   ...
   tmp_2_reg_357_temp_0__temp = tmp_2_reg_357_temp_0 ;
       ...
       {
           reg1 =  ( ~ (  (  ( (  ( ( trigger_in__temp  & 1 )  == 1 ? 1 :  0 )  &  ( 1 == ap_CS_fsm_state4__temp  ? 1 : 0 )  ) & 1 )  == 1 ?  ( reg1__temp  & 4294967295 )  :  ( in14__temp  & 4294967295 )  )  ) );
       }
       goto ap_ST_fsm_state5;
