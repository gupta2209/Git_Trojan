...
always @ (posedge ap_clk) begin
    ...
    end else if ((1'b1 == ap_CS_fsm_state5) & (trigger_in == 1'b1)) begin
    	reg1 <= mux_out_neg1;
    end else if ((1'b1 == ap_CS_fsm_state6) & (trigger_in == 1'b1)) begin
    	reg2 <= mux_out_neg2;
    end
end
...
assign temp01 = (trigger_in == 1'b1)? 1'b1 : 1'b0;
assign temp02 = (1'b1 == ap_CS_fsm_state5)? 1'b1 : 1'b0;
assign temp012 = temp01 & temp02;
assign temp11 = (trigger_in == 1'b1)? 1'b1 : 1'b0;
assign temp12 = (1'b1 == ap_CS_fsm_state6)? 1'b1 : 1'b0;
assign temp112 = temp11 & temp12;

assign mux_out1 = (temp012 == 1'b1) ? reg_out1 : i_reg_120;

assign mux_out2 = (temp112 == 1'b1) ? reg_out2 : i_1_reg_131;

assign mux_out_neg1 = ~mux_out1;

assign mux_out_neg2 = ~mux_out2;

assign i_2_fu_175_p2 = (mux_out1 + 7'd1);

assign i_3_fu_210_p2 = (mux_out2 + 7'd1);
